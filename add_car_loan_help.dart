...
class AddCarLoanHelp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Add Car Loan Help'),),
          ...
          child: Column(
            ...
            children: <Widget>[
              RichText(
                text: TextSpan(
                  children: <TextSpan>[
                    TextSpan(text: 'To add your car loan, which is paid on a regular timescale you use a ', style: HC.st),
                    ...
                    TextSpan(text: '\n\nWatch the YouTube video that describles how to enter your car loan into a new Planned Transaction', style: HC.st),
                  ],
                ),
              ),
              RichText(
                text: TextSpan(children: <TextSpan>[
                  TextSpan(text: '\nYouTube Add Your Car Loan\n', 
                  recognizer: TapGestureRecognizer()..onTap = () {
                    launch('https://youtu.be/r2aQNclgLvI');
                    },
                  style: HC.stbl),],
                ), 
              ),              
